...
class AdViewController: UIViewController {
    ...
    let controller: AdController = AdController()
    ...
    private lazy var dataSource = AdDataSource(tableView: self.tableView)
...
extension AdViewController: ViewConfiguration {
...
extension AdViewController: AdControllerDelegate {
    func show(immobile: [Immobile]) {
        dataSource.updateImmobileRent(immobiles: immobile)
    }
}
