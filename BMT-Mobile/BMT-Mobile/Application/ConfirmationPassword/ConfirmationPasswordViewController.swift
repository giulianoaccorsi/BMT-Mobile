...
class ConfirmationPasswordViewController: UIViewController {
    
    var controller: ConfirmationPasswordController = ConfirmationPasswordController()
    ...
    lazy var tokenTextField:FormTextField = {
        let textField = FormTextField()
        textField.translatesAutoresizingMaskIntoConstraints = false
    ...
    @objc func forgotPasswordTapped() {
        ...
        let token = tokenTextField.validate()
        if  validEmail && token {
            // Chamada Controller
        }
    }
...
extension ConfirmationPasswordViewController: ViewConfiguration {
    ...
    func setUpConstraints() {
        NSLayoutConstraint.activate([
            ...
            tokenLabel.topAnchor.constraint(equalTo: emailTextField.bottomAnchor, constant: 16),
            tokenLabel.leadingAnchor.constraint(equalTo: forgotPasswordLabel.leadingAnchor),
            tokenLabel.heightAnchor.constraint(equalToConstant: 40),
            ...
            tokenTextField.leadingAnchor.constraint(equalTo: emailLabel.leadingAnchor),
            tokenTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -15),
            tokenTextField.heightAnchor.constraint(equalToConstant: 40),
